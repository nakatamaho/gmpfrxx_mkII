...
COMMAND_RE = re.compile(r"^COMMAND\s+Rgemv\s+(\S+)\s+(\S+)\s+(.+)$")
...
def display_name(raw):
    return raw.removeprefix("Rgemv_mpfr_")
...
def main():
    ...
    parser.add_argument("--title-prefix", default="MPFR Rgemv repeat benchmark")
