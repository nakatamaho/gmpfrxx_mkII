...
rgemv_m="${6:-4000}"
rgemv_n="${7:-4000}"
output_root="${8:-${script_dir}/results_raw/run_all_p${precision}_repeat${repeat_count}_$(date +%Y%m%d_%H%M%S)}"
