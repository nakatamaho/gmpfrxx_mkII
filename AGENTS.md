...
```text
GMPFRXX_MKII_MPC_DEFAULT_PRECISION_BITS
GMPFRXX_MKII_MPC_REAL_PRECISION_BITS
GMPFRXX_MKII_MPC_IMAG_PRECISION_BITS
GMPFRXX_MKII_MPC_ROUNDING
GMPFRXX_MKII_MPC_REAL_ROUNDING
GMPFRXX_MKII_MPC_IMAG_ROUNDING
```
